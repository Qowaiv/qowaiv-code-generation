...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AutoGeneratedHeader"/> class.
    /// </summary>
    [Obsolete("Use Headers.AutoGenerated instead")]
    public AutoGeneratedHeader()
        : this(null)
    {
    }
    ...
    /// </summary>
    [Obsolete("Use Headers.AutoGenerated instead")]
    public AutoGeneratedHeader(IEnumerable<Assembly>? toolchain)
    {
    ...
    private static bool HasAllowedPrefix(string? asm)
    {
        ...
        return !IgnoredPrefixes.Exists(prefix => asm.StartsWith(prefix, StringComparison.OrdinalIgnoreCase));
    }
}
